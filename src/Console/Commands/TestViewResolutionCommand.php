...
{
    protected $signature = 'coupons:test-views';
    protected $description = 'Test view resolution for Coupons module';

    public function handle()
    {
        $this->info('🔍 Testing View Resolution for Coupons Module...');
        ...
        foreach ($testViews as $viewName) {
            ...
            $namespaces = [
                'coupons-module::' . $viewName => 'Module View',
                'coupons::' . $viewName => 'Package View',
            ];
        ...
        $controller = new \Modules\Coupons\app\Http\Controllers\Admin\CouponManagerController();
        ...
        $this->info("\n📋 View Loading Order:");
        $this->info("1. coupons-module:: (Module views - highest priority)");
        $this->info("2. coupons:: (Package views - fallback)");

        $this->info("\n💡 Tips:");
        $this->info("- Edit views in Modules/Coupons/resources/views/ to use module views");
